...
<?php
	...
	echo $form->hidden('original_id',array('value'=>$account['Account']['original_id']));
?>
	<input type="hidden" name="prePage" value="<?php echo $prePage; ?>" />
	<div id="page_title">編集（複写）</div>
	<div id="base">
		<h2>基本情報</h2>
		<table>
			<tr>
...
?>
	...
	<div id="local_menu">
		<div class="menu_block">
			<h3>書類作成</h3>
			<ul>
				<li><a href="/sys/accounts/view/<?php echo $account['Account']['original_id']; ?>">キャンセル</a></li>
