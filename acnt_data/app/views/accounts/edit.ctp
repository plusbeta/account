	...
	<div id="base">
		...
		<table>
			...
			<tr>
				...
				<th>自社担当者２</th>
				<td><?php echo $form->select('sub_member_id',$members,$account['Account']['sub_member_id'],array(),'選択'); ?></td>
			</tr>
			<tr>
				<th>外注先１（発注額）</th>
				<td>
		...
		<table>
			<tr>
				...
				<?php echo $form->input('temporary',array('value'=>$account['Account']['temporary'],'label'=>'概算見積書（見積書タイトルに「概算」が付加されます。）')); 
...
<?php
	...
	echo $form->select('estimate_flag',array('0'=>'未見積','1'=>'見積済'),$account['Account']['estimate_flag'],array(),null);
?>
				</td>
			</tr>
			<tr>
...
<?php
	...
	echo $form->select('delivery_flag',array('0'=>'未納品','1'=>'納品済'),$account['Account']['delivery_flag'],array(),null);
?>
				</td>
			</tr>
			<tr>
...
<?php
	...
	echo $form->select('bill_flag',array('0'=>'未請求','1'=>'請求済'),$account['Account']['bill_flag'],array(),null);
?>
				</td>
			</tr>
			<tr>
...
<?php
	...
	echo $form->select('receive_flag',array('0'=>'未回収','1'=>'回収済'),$account['Account']['receive_flag'],array(),null);
?>
				</td>
			</tr>
			<tr>
	...
	<div id="local_menu">
		<div class="menu_block">
			<h3>書類作成</h3>
			<ul>
				<li><a href="/sys/accounts/view/<?php echo $account['Account']['id']; ?>">詳細へ戻る</a></li>
